...
namespace Day04
{
    internal class Program
    {
        ...
        private static void SolvePart2()
        {
            ...
            g = guards.OrderByDescending(g => g.SleepTimes.Max(x => x)).First();
            var m = g.SleepTimes.Max();
            var index = g.SleepTimes.ToList().IndexOf(m);
            Console.WriteLine("Solution = " + (g.Id * index));
        }
    }
